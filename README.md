...
- formularz importu i edycji renderuje ordinary affixy w wizualnej kolejności z tooltipa: najpierw po `visualSourceText` / `visualDisplayOrder`, potem po `displayOrder` wybranego kandydata. Renderer nie może przestawiać listy alfabetycznie, po enumie, score, map insertion order, nazwie ani po typie affixu,
