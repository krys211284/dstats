...
- `TRANSFIGURATION_CANDIDATE` zapisuje rozpoznaną definicję przeistoczenia, displayed value i source range, jeżeli OCR go dostarczył; `ASPECT_MATCH` zapisuje `selectedAspectId`, status runtime i kanoniczny tekst efektu użyty w formularzu,
