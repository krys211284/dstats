...
- `+3 do umiejętności: Główne` jest katalogowane i prezentowane jako opisowy ordinary affix `CORE_SKILL_RANKS`; dopóki repo nie ma zweryfikowanego runtime rang z itemów, nie wpływa na `effectiveRank` ani DPS,
