...
- każdy wiersz affixu pozwala oznaczyć `Greater Affix`; gwiazdka jest wyłącznie prezentacją, a trwały kontrakt danych stanowi pole `greaterAffix`,
...
- pełny odczyt rozdziela linie co najmniej na: nazwa, typ / slot, rzadkość, moc przedmiotu, bazowa wartość, affix, aspekt / moc, gniazdo oraz inna linia,
...
- użytkownik może dodać wiele affixów w kolejnych akcjach `Dodaj affix`, a stan formularza, zaznaczenia `Greater Affix`, wybrany aspekt i projekcja runtime muszą przetrwać walidację,
...
- karta itemu w bibliotece pokazuje podgląd `Pełniejszy odczyt itemu` z nazwą, typem, rzadkością, mocą, bazową wartością oraz zachowanymi liniami OCR,
...
- GUI pokazuje ręczny formularz zatwierdzenia z edytowalną listą affixów: użytkownik może zmienić typ i wartość affixu, oznaczyć `Greater Affix`, oznaczyć wiersz do usunięcia albo dodać brakujący affix z katalogu przez osobną akcję `Dodaj affix`,
