...
- Od tego etapu `Starcie` z aktywną bronią daje niezerowe bazowe direct damage w runtime: rank `1` używa `115%`, a ranki `2..5` używają `126%`, `138%`, `149%`, `167%`. To nie podłącza efektu unikatowego Odłamka Verathiela, Lucky Hit Verathiela, upgrade'ów Starcia ani `effectiveRank`.
