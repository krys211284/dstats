...
- runtime `CRITICAL_STRIKE_CHANCE` dla mitycznego unikatu używa potwierdzonej wartości widocznej na tooltipie, np. `15,0` z Dziedzica Zatracenia; `referenceValue = 12,0` nie jest przeliczane ponownie przez Doskonalenie, więc Paladyn poziomu `70` ma `5,2 + 15,0 = 20,2`, a nie `23,2`,
