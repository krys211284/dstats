...
- affix `Szczęśliwy traf: odzyskanie podstawowego zasobu` jest złożony: UI pokazuje jednoznacznie `15% / +3` i zakres `3 - 4`; sama liczba `3` jest techniczną ilością zasobu do zapisu, nie pełną widoczną wartością affixu,
