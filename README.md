...
- item używany przez aktywnego bohatera jest oznaczony statusem `Używany`, a pozostałe itemy statusem `Nie używany`,
...
- GUI biblioteki pokazuje zapisane itemy pogrupowane po slocie wraz z nazwą, źródłem, identyfikatorem i skrótem wkładu do current build,
- GUI biblioteki pokazuje rozwijany podgląd `Pełniejszy odczyt itemu`, jeżeli item ma zapisane linie `FullItemRead`,
- GUI biblioteki pozwala mieć wiele itemów tego samego slotu,
- GUI biblioteki wyraźnie oznacza item używany przez aktywnego bohatera badge'em `Używany`, a pozostałe itemy badge'em `Nie używany`,
...
- SSR przeglądu biblioteki itemów pogrupowanego po slocie,
- SSR założenia itemu z biblioteki do zgodnego slotu aktywnego bohatera,
- render statusu `Używany` / `Nie używany` względem aktywnego bohatera,
