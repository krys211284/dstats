...
- GUI pozwala ustawić konfigurację wyłącznie przypisanych umiejętności bohatera, jego pasek akcji oraz wybrane itemy w slotach, a zapis wykonuje sticky przycisk `Zapisz zmiany`.
