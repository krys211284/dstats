...
- GUI po zapisie do biblioteki pokazuje nazwę itemu, slot i identyfikator oraz na stronie biblioteki upraszcza dalsze akcje do `Załóż bohaterowi`, `Zmień w slocie` i `Wróć do aktualnego buildu`,
