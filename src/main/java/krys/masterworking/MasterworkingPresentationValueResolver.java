...
public final class MasterworkingPresentationValueResolver {
    ...
    private static boolean percentAffix(ImportedItemAffixType type) {
        return switch (type) {
            case DAMAGE_REDUCTION, BLOCK_CHANCE, RETRIBUTION_CHANCE, CRITICAL_STRIKE_CHANCE, LUCKY_HIT_CHANCE,
                 COOLDOWN_REDUCTION, MOVEMENT_SPEED, DODGE_CHANCE, ALL_DAMAGE_MULTIPLIER, DAMAGE_OVER_TIME_MULTIPLIER -> true;
            case STRENGTH, INTELLIGENCE, THORNS, ALL_RESISTANCE, FIRE_RESISTANCE, WEAPON_DAMAGE_FLAT,
                 MAXIMUM_LIFE, LIFE_ON_HIT, LIFE_ON_KILL, LUCKY_HIT_PRIMARY_RESOURCE, CORE_SKILL_RANKS -> false;
        };
    }
}
